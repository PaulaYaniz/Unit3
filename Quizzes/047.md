![image](https://user-images.githubusercontent.com/89135778/225357901-5bba3a04-cf99-4ec5-89b9-efd7c5e86d3d.png)
    ...
    def update(self):
        ...
        if base != "":
            ...
            # 4- if the TextField.text has a number (value), calculate the equation new_value="(base*int(value)//100) JPY" and subbctract the equation to the total
                if value != "":
                    new_value = int(value) * int(base) / 100
            ...
            # 6- set the label next to the TextField (inhabitant_label, income_tax_label, etc) to the variable new_value
                self.root.ids[f"{item}_label"] = new_value
                print(f"{item}_label")
...
https://user-images.githubusercontent.com/89135778/225359739-d33e6245-30e0-44f6-8b49-7cb16f97b7bd.mp4
